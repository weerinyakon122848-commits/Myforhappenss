...
class TanangScreen extends StatelessWidget {
  const TanangScreen({super.key});
        ...
        children: [
          Column(
            children: [
              ...
              // --- ส่วนหัว (เปลี่ยนข้อความเป็นท่านั่ง) ---
              FadeInUp(
